...
public class Antibody {
    ...
    public int number_of_connections; // number of antigens connecting to this antibody (must be reset at every training cycle)
    public Antigen[] antigens; // the antigens which this antibody is connected to (within RR)
    public double[] affinities; // the affinities to the antigens (must be in the same order as antigens)
    ...
    public Antibody(List<String> record, float RR_radius) {
